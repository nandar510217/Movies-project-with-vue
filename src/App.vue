...
<script setup>
  ...
  const movies = ref([
    ...
    },
    {
      id:2,
      name: 'Harry Potter',
      imageSrc: '/images/Harry Potter.jpg',
      year:'2020',
      isTop: true
    },
    {
